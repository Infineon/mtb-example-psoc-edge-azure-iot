 ...
 * Macros
 ********************************************************************************/
#define DEFAULT_START_TEMP_COUNT                    (1U)
#define DEFAULT_START_TEMP_CELSIUS                  (22.0)
#define DOUBLE_DECIMAL_PLACE_DIGITS                 (2U)

/* Wait duration between messages, should be in multiples of 500 */
#define MESSAGE_WAIT_LOOP_DURATION_MSEC             (500U * 500U)

#define SAS_KEY_DURATION_MINUTES                    (240U)
#define MQTT_CLIENT_ID_BUFFER_SIZE                  (128U)
#define CONNECTION_REQUEST_ID_BUFFER_SIZE           (16U)
#define COMMAND_START_TIME_VALUE_BUFFER_SIZE        (64U)
#define COMMAND_END_TIME_VALUE_BUFFER_SIZE          (64U)
#define COMMAND_RESPONSE_PAYLOAD_BUFFER_SIZE        (256U)
#define METHODS_RESPONSE_TOPIC_BUFFER_SIZE          (128U)

#define GET_QUEUE_TIMEOUT_MSEC                      (500U)
#define PNP_APP_TIMEOUT_MSEC                        (500U)
#define PNP_MSG_EVENT_QUEUE_MSEC                    (500U)
#define PNP_MSG_EVENT_QUEUE_LENGTH                  (10U)
 ...
 *
 *  response: Represents a "view" over a byte buffer that represents a
 *  contiguous region of memory. It contains a pointer to the start of the 
 *  byte buffer and the buffer's size.
 *
 * Return:
 *  void
 ******************************************************************************/
