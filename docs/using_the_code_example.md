...
The following example clones the "[Azure-IoT](https://github.com/Infineon/mtb-example-psoc-edge-azure-iot)" application with the desired name "AzureIoT" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-azure-iot --user-app-name AzureIoT --target-dir "C:/mtb_projects"
   ```
